...
// Declare temperature and hold time variables for each phase
float tempPhase1, tempPhase2, tempPhase3, tempPhase4, tempPhase5;
int holdTimePhase1, holdTimePhase2, holdTimePhase3, holdTimePhase4, holdTimePhase5;
            ...
            while (startIndex < command.length()) {
                ...
                if (commaIndex != -1) {
                    ...
                    switch (phaseIndex) {
                        case 0: 
                            tempPhase1 = temp; 
                            holdTimePhase1 = holdTime; 
                            Serial.print("Phase 1 - Temp: "); Serial.print(temp); Serial.print(", Hold Time: "); Serial.println(holdTime); // Debugging output
                            break;
                        case 1: 
                            tempPhase2 = temp; 
                            holdTimePhase2 = holdTime; 
                            Serial.print("Phase 2 - Temp: "); Serial.print(temp); Serial.print(", Hold Time: "); Serial.println(holdTime); // Debugging output
                            break;
                        case 2: 
                            tempPhase3 = temp; 
                            holdTimePhase3 = holdTime; 
                            Serial.print("Phase 3 - Temp: "); Serial.print(temp); Serial.print(", Hold Time: "); Serial.println(holdTime); // Debugging output
                            break;
                        case 3: 
                            tempPhase4 = temp; 
                            holdTimePhase4 = holdTime; 
                            Serial.print("Phase 4 - Temp: "); Serial.print(temp); Serial.print(", Hold Time: "); Serial.println(holdTime); // Debugging output
                            break;
                        case 4: 
                            tempPhase5 = temp; 
                            holdTimePhase5 = holdTime; 
                            Serial.print("Phase 5 - Temp: "); Serial.print(temp); Serial.print(", Hold Time: "); Serial.println(holdTime); // Debugging output
                            break;
                    }
                    phaseIndex++;
                }
...
void loop() {
    ...
    //handleThermocycling();        
    //Go through 30 thermocycles without PID